...
import { FolderPlus, Trash2, Edit3, Upload, Globe, Lock, Code, File, ArrowLeft ,ChevronLeft, ChevronRight,Folder, Search, X } from 'lucide-react';
...
const Dashboard = () => {
    ...
    // Read view query param to auto-open create form
    useEffect(() => {
                        ...
                        {uploadMode === 'files' && (
                            <div className="field" style={{ marginBottom: '20px' }}>
                                <label style={{ position: 'relative', top: '0', transform: 'none', color: 'var(--ch-text-dim)', display: 'block', marginBottom: '10px', fontSize: '0.9rem' }}>
                                   Select the upload path (Root is the default)
                                </label>
                                ...
                                {isFetchingFolders ? (
                                    ...
                                    <div style={{
                                        ...
                                        {repoFolders.map((folder, idx) => {
                                            ...
                                            const displayName = isRoot ? 'Main folder (Root)' : parts[parts.length - 1];
