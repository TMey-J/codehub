...
import { Code, Folder, File, ArrowLeft, Globe, Lock, Download, Calendar, ChevronRight, ChevronDown, FileText, Copy, Check, Info, Lightbulb, AlertTriangle, AlertCircle, Octagon, Trash2, Loader2 } from 'lucide-react';
...
const RepoDetail = () => {
    ...
    setActiveFile(file);
    setFileContent('');
    setIsBinaryFile(false); // ریست کردن وضعیت برای فایل جدید
        ...
        if (confirmResult.isConfirmed) {
            try {
                ...
                if (response.data.is_success) {
                    ...
                    setActiveFile(null);
                    fetchRepositoryData(); // رفرش کردن لیست فایل‌ها
                }
            } catch (error) {
                Swal.fire({
                    icon: 'error',
