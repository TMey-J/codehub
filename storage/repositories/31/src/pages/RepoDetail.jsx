    ...
    const handleDownloadRepository = async () => {
        try {
            ...
            Swal.fire({
                ...
                text: 'Could not download the repository.',
                background: 'rgba(16, 16, 24, 0.95)',
                color: '#fff'
            });
        }
                ...
                <div style={{ margin: '16px 0', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--ch-border)' }}>
                    <div style={{
                        ...
                        <button onClick={handleCopy} style={{
                            ...
                            cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', fontFamily: 'inherit', transition: 'color 0.2s'
                        }}>
    ...
    if (isLoading) {
        return (
            <div className="ch-repo-container content-fade-in">
                ...
                <div className={`repo-explorer-layout ${activeFile ? 'is-viewing-code' : 'is-viewing-readme'}`}>
