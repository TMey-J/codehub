...
class AIService:
    ...
    async def vulnerability(self, code_snippet: str) -> str:
        system_prompt = (
    ...
    async def vulnerability_persian(self, code_snippet: str) -> str:
        system_prompt = (
            "You are an expert DevSecOps analyzer. Your sole purpose is to analyze the provided code "
            "and return a STRICT JSON object representing its quality and security in Persian (Farsi). "
            "DO NOT include markdown backticks, conversational filler, or explanations outside the JSON. "
            "The JSON must strictly follow this schema:\n"
            "{\n"
            '  "scores": {\n'
    ...
    async def optimization(self, code_snippet: str) -> str:
        system_prompt = (
    ...
    async def readme(self, project_info: str) -> str:
        system_prompt = (
    ...
    async def readme_persian(self, project_info: str) -> str:
        system_prompt = (
            "You are an expert technical writer and developer advocate. "
