            ...
            {view === 'list' && (
                <div className="ch-grid">
                    {isLoading ? (
                        ...
                        repos.map(repo => (
                            <div key={repo.id} className="ch-card">
                                <div className="ch-card-header" style={{ justifyContent: 'space-between' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px' }}>
                                        <button className="ch-icon-btn" onClick={() => handleEditClick(repo)} title="Edit Repository">
                                            <Edit3 size={16} />
                                        </button>
                                        <button className="ch-icon-btn" onClick={() => { setSelectedRepo(repo); setView('upload'); setError(null); }} title="Upload Files">
                                            <Upload size={16} />
                                        </button>
                                        <button className="ch-icon-btn" style={{ color: '#ef4444' }} onClick={() => handleDeleteRepo(repo.id)} title="Delete Repository">
                                            <Trash2 size={16} />
                                        </button>
                                    </div>
                                </div>
